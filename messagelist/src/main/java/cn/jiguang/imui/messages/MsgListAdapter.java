...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    public MsgListAdapter(Context context, String senderId, ImageLoader imageLoader) {
        this(context, senderId, new HoldersConfig(), imageLoader);
    }

    public MsgListAdapter(Context context, String senderId, HoldersConfig holders, ImageLoader imageLoader) {
